...
class TurtleBot3:
    ...
    def __init__(self):
        ...
        self.min_dist_to_obstacle = 0.5  # Distance minimale à un obstacle en mètres
    ...
    def laser_callback(self, data):
        ...
        # Si un obstacle est détecté, arrêter le robot, reculer et tourner
        if self.obstacle_detected:
            self.move_cmd.linear.x = 0.0
            self.move_cmd.angular.z = self.turn_gain * (scan[0] - scan[-1])
